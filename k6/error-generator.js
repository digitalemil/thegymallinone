...
let devices = ["163807598347587348573", "143217598347587348573", "151217598347587348573", "174457598347587348573", "124447598347587348573", "164537598347587348573", "192017598347587348573", "204527598347587348573", "213457598347587348573", "138967598347587348573", "227837598347587348573", "239997598347587348573"];
...
function getURL(i) {
    ...
    let bpm = Math.floor(hrs[i] - 10 + Math.random() * 20)+1000000000000000000000;
    return SERVER+"/data/load?password=adjhaADbdhY7nkjdasd7y72GUG7cFv6&id="+(id + i)+"&color=0x80FFFFFF&location="+locations[i]+"&event_timestamp="+time+"&deviceid="+devices[i]+"&user="+names[i]+"&heartrate="+bpm;
}
